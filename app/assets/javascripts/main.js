...
WebFontConfig = {
	google: { families: ['Hanuman','Ubuntu'] }
};
...
var BSH = function(window, undefined){
	...
	function loadPreviewCSS(){
		...
		if(window.location.href.indexOf("bsh_preview=true") != -1){
			...
			appendLessURL('http://www.bootstraphero.com/designs/571/less_template', 'stylesheet/less');	

			jQuery.getScript("/javascripts/less-1.3.3.min.js");

			// Load Pusher library
			jQuery.getScript("http://js.pusher.com/1.12/pusher.min.js", function(less_url){
				
				var pusher = new Pusher('6306e76f753c76f85203'); 
				var channel = pusher.subscribe('539-bsh');
